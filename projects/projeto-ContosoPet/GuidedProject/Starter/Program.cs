...
do
{
    ...
    switch (menuSelection)
    {
        ...
        case "2":
            // Add an animal friend to the ourAnimal array
            string anotherPet = "y";
            int petCount = 0;
            for (int i = 0; i < maxPets; i++)
            {
            ...
            {
                // increment petCount (the array is based-zero, so we increment the counter after adding to the array)
                petCount = petCount + 1;
                ...
                if (petCount < maxPets)
                {
                    ...
                    // get the pet's age. Can be ? at inicial entry.
                    do
                    {
                        int petAge;
            ...
            if (petCount >= maxPets)
            {
                Console.WriteLine("We have reached our limit on the number of pets the we can manage.");
                Console.WriteLine("Press the Enter key to continue.");
                readResult = Console.ReadLine();
            }
        ...
        case "3":
            // Enure animal ages and physical descriptions are complete
        ...
        case "5":
            ...
            Console.WriteLine("Press the Enter key to see progress.");
            readResult = Console.ReadLine();
            break;
